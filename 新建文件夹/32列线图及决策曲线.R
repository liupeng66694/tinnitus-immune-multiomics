...
# 设置工作目录
setwd("D:\\02_生信分析狮\\tinnitus\\32列线图及校准曲线")  # 设置工作目录
...
lrmModel = lrm(Type ~CRIM1+	CD33+	GABBR1	+SH2B3	+SLC9A1, data = rt, x = TRUE, y = TRUE)  # 构建逻辑回归模型
...
dc = decision_curve(Type ~ CRIM1+	CD33+	GABBR1	+SH2B3	+SLC9A1, data = rt, 
